...
//        ExprTokenizer t = new ExprTokenizer("m = (5^2) n=6 k=10-9 while(n){if(k)then{n=n-2}else if(n)then n=n-2 else {n=n-5}}");
//        ExprTokenizer t = new ExprTokenizer("m = (5^2) n=5-0 if(n) then m=m+3 else if(n) then {shoot up 3} else {move up m=m-5}");
//        ExprTokenizer t = new ExprTokenizer("m = (5^2) n=2-5 if(n) then m=m+3 else if(n) then {shoot up 20} else {move up m=m-5}");
//        ExprTokenizer t = new ExprTokenizer("m = (5^2) n = 2-5 if(n) then m=m+3 else {done} ");
...
//        ExprTokenizer t = new ExprTokenizer("m =5 if(3-4)then {} else{ collect 5 }");
//        ExprTokenizer t = new ExprTokenizer("m =5 if(3-4)then {} else{ collect 5 }");
...
//          ExprTokenizer t = new ExprTokenizer("m =5 if(0-1)then {n=opponent} else{ collect 5 }");
        ExprTokenizer t = new ExprTokenizer("m = 25 n=6 while(m){m = m-5 while(n){if(m)then n=n-2 else {n=n-5} }}");
